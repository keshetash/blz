...
// ── GroupInfoModal ─────────────────────────────────────────────────────────────
function GroupInfoModal({ chat, onClose, onViewUser, meId }: {
  chat: Chat; onClose: () => void; onViewUser: (id: string) => void; meId: string;
}) {
  return (
    <div className="modalOverlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="groupInfoCard">
        ...
        <div className="giMemberList">
          {chat.members.map(m => (
            <button key={m.id} className="giMemberItem" onClick={() => { onViewUser(m.id); onClose(); }}>
